package org.openpaas.servicebroker.api.service;
...
public class SampleAPICatalogService implements CatalogService {

	private static final Logger logger = LoggerFactory.getLogger(SampleAPICatalogService.class);
	...
	@Autowired
	public SampleAPICatalogService(Catalog catalog) {
